...
---
Github link:
https://github.com/Soul22238/STATS506
...
## g
The number of times dining out was treated as a numeric variable, with valid values being non-negative and within a reasonable upper limit (less than 10,000).
```{r}

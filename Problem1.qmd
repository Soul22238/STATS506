...
c.3
The whole weight of the abalone that has the maximum rings is 1.875. 
The shucked weight of the abalone that has the maximum rings is 0.7055.
The viscera weight of the abalone that has the maximum rings is 0.3215.
The shell weight of the abalone that has the maximum rings is 0.475.
```{r}
